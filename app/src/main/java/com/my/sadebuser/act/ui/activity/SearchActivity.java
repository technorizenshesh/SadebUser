...
public class SearchActivity extends AppCompatActivity {
    ...
    private final List<com.my.sadebuser.act.model.serviceprovider.ResultItem> serviceproviderlist = new ArrayList<>();
    ...
    private void init(){
        ...
        adapter = new HomeSaloonRecyclerViewAdapter(this, serviceproviderlist);
