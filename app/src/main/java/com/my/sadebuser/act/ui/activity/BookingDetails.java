...
import com.my.sadebuser.act.model.booking.BookingResponse;
                        ...
                        public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                            ...
                            if (response != null) {
                                if (response.isSuccessful()) {
                                    ...
                                    if (status == 1) {
                                        Toast.makeText(BookingDetails.this, "Your Request is successfully sent to admin", Toast.LENGTH_SHORT).show();
